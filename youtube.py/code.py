...
if page == "HOME":
    ...
    if Channel_id:
        ...
        st.write(cd)
    data = {
    "Channel_Name": ["DATAVECTOR 3099", "WeCreators", "Lukonde Mwila", "PENP_","YOU_SOURCE"],
    "Channel_ID": ["UCQOV6j0VbzRy9uCvlisk81w", "UCVH8fYdkQaG_2aepSOBeNkw", "UCz98Ics0hXj0Lv1U2Y6BObQ", "UCTcTMIkKyv-kNq8bxUhOksw","UCplQgzf7gVZxAxDgjh27mtA"],
    }
