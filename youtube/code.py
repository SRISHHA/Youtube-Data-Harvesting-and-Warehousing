...
if page == "HOME":
    ...
    if Channel_id:
        ...
        st.write(cd)
    data = {
    "Channel_Name": ["DATAVECTOR 3099", "Sameun Syed", "Lukonde Mwila", "PENP_"],
    "Channel_ID": ["UCQOV6j0VbzRy9uCvlisk81w", "UCplQgzf7gVZxAxDgjh27mtA", "UCz98Ics0hXj0Lv1U2Y6BObQ", "UCTcTMIkKyv-kNq8bxUhOksw"],
    }
